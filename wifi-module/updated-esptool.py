...
class ESPLoader(object):
    ...
    @staticmethod
    def detect_chip(port=DEFAULT_PORT, baud=ESP_ROM_BAUD, connect_mode='no_reset', trace_enabled=False,
    ...
    def _connect_attempt(self, mode='no_reset', esp32r0_delay=False):
...
class ESP8266StubLoader(ESP8266ROM):
    ...
    """
    FLASH_WRITE_SIZE = 0x140  # matches MAX_WRITE_BLOCK in stub_loader.c
    IS_STUB = True
